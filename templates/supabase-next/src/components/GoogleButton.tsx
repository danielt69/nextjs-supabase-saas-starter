...
export function GoogleButton() {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-2 rounded-md border border-neutral-700 px-4 py-2.5 text-sm font-medium transition hover:bg-neutral-900"
    >
      <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path
          fill="#4CAF50"
          d="M24 45c5.2 0 10-2 13.6-5.2l-6.3-5.3C29.2 36 26.7 37 24 37c-5.3 0-9.7-3.6-11.3-8.4l-6.5 5C9 40.3 15.9 45 24 45z"
        />
        <path
          fill="#1976D2"
